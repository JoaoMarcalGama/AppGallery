        ...
        public static List<PaginaColecao> MenuItensColecao{ 
            get{
                var paginas = new PaginaColecao()
                {
                    ...
                    new Pagina() { Nome = "CarouselPage", Descricao = "Navegue entre páginas lado a lado", ArquivoPagina = typeof(XamarinForms.Paginas.PaginaDeCarrosel.Carrosel), TemNavegacao = false },
                    new Pagina() { Nome = "TabbedPage", Descricao = "Navegação em abas", ArquivoPagina = typeof(XamarinForms.Paginas.PaginaDeAba.Abas), TemNavegacao = false },
                ...
                var controles = new PaginaColecao()
                {
                    ...
                    new Pagina() { Nome = "Editor", Descricao = "Controle de entrada de texto em várias linhas", ArquivoPagina = typeof(XamarinForms.Controles.CampoDeEntradaMultilineControle.CampoDeControleMultiline), TemNavegacao = true },
                    ...
                    new Pagina() { Nome = "RefreshView", Descricao = "Componente com ação de pull (Puxar) utilizado para atualização de uma tela ou componente", ArquivoPagina = typeof(XamarinForms.Controles.AtualizarControle.Atualizar), TemNavegacao = true },
                ...
                var animacoes = new PaginaColecao()
                {
                ...
                {
                    new Pagina() { Nome = "Display", Descricao = "Apresente Pop-ups para o usuário", ArquivoPagina = typeof(XamarinForms.Classes.Alerta.Alerta), TemNavegacao = true },
